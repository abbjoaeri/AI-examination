...
En annan sak som skulle kunna utvecklas skulle vara att lägga upp projektet på en molntjänst där koden görs om och om igen. En sådan molntjänst skulle exempelvis kunna vara antingen Microsofts Azure eller heroku. Det sistnämnda alternativet har jag försökt lägga upp projektet på men utan att lyckas. Troligtvis beror det på att storleken på den modell som används för att känna igen bilder är alldelles för stor. I nuläget ligger koden uppe på en dator här hemma som står igång hela tiden, samma funktion fås ut även om det är lite mindre praktiskt än om hela projektet skulle ligga på en molntjänst. Något som blir väldigt svår med tanke på att en för stor modell används i detta fall. 
## Frågor?
